...
@Named("patientHasMaladieController")
@SessionScoped
public class PatientHasMaladieController implements Serializable {
    ...
    public String prepareList() {
        recreateModel();
        return "/patientHasMaladie/ListMaladie.xhtml?faces-redirect=true";
    }
    ...
    public String create(Patient p) {
        try {
            current.getPatientHasMaladiePK().setPatientID(p.getId());
            current.getPatientHasMaladiePK().setMaladieID(current.getMaladie().getId());
            getFacade().create(current);
            p.getPatientHasMaladieList().add(current);
    ...
    public String destroy(PatientHasMaladie PM,Patient P) {
        ...
        recreatePagination();
        recreateModel();
        return "ListMaladie?faces-redirect=true";
    }
    ...
    public static class PatientHasMaladieControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PatientHasMaladieController controller = (PatientHasMaladieController) facesContext.getApplication().getELResolver().
